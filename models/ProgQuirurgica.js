...
// Schema de progQuirurgica

let progQuirurgicaSchema = new Schema({
  // Nombre de progQuirurgica

  EsUrgenteoProgramada: {
    type: String,
    minlength: 1,
    uppercase: true,
    required: [true, 'un Urgente o Programada es necesario.']
  },
  genero: {
    type: String,
    enum: generoValido,
    maxlength: 1,
    uppercase: true,
    required: [true, 'Se requiere especificar el género del progQuirurgica.']
  },
  fechaNacimiento: {
    type: Date,
    required: [true, 'La fecha de nacimiento del progQuirurgica es necesaria.']
  },
...
progQuirurgicaSchema.plugin(uniqueValidator, { message: '{PATH} debe ser único. ' })





module.exports = mongoose.model('Paciente', progQuirurgicaSchema);
